...
class GameEngine {
private:
	static std::vector<GameObject*> objects; ///<Vector of (pointers to) game objects: all the objects in the game.
...
public:
	...
	static void addGameObject(GameObject* object, bool camFollow = false); ///<Adds a GameObject to the game.
